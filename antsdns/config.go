...
type Config struct {
	IspAddress   string                  `json:"ispAddress"`
	AppIdSecretRef cmmetav1.SecretKeySelector `json:"appIdSecretRef"`
	AppKeySecretRef cmmetav1.SecretKeySelector `json:"appKeySecretRef"`
}
